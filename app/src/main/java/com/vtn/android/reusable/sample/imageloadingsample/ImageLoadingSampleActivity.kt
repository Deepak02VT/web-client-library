package com.vtn.android.reusable.sample.imageloadingsample
...
import com.imageloader.load
import com.vtn.reusable_component.R
import com.vtn.reusable_component.databinding.ActivityMainBinding
import java.io.File
...
class ImageLoadingSampleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imageViewForDrawable.load(R.drawable.dummy_user_image)
        binding.imageViewForUrl.load(
            "https://cdn.shopify.com/s/files/1/0592/0342/0346/products/1.BesanLaddu.jpg?v=1629655689",
            R.drawable.dummy_user_image,
            R.drawable.dummy_user_error_image,
